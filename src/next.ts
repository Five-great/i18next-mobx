...
import { isExternalUrl, isFunction, isServer, loadFetch, parseLanguageHeader, parseLanguageHeaderCookie } from "./tools";
...
export const withNextI18NextMobxApp = (nextAppComponent: {
  ({ Component, pageProps });
  getInitialProps?: any;
}) => {
